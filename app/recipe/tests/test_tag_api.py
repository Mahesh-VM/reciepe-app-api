...
class PrivateTagApiTest(TestCase):
    ...
    def test_tag_created_succesfully(self):
        """ test to creste s tag successfully"""
        payload = {'name': 'tag testing'}
    ...
    def test_invalid_tag_created(self):
        """test a invalid tag creation"""
        payload = {'name': ''}
